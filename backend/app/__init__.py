...
def create_app():
    ...
    # Desktop app may run without FLASK_ENV set, so always include localhost and Tauri origins
    allowed_origins = [
        # Development origins
        "http://localhost:5173", 
        "http://127.0.0.1:5173", 
        "http://localhost:1420", 
        "http://127.0.0.1:1420",
        # Tauri desktop app origins (all possible variations)
        "tauri://localhost",
        "https://tauri.localhost",
        "http://tauri.localhost",
        # null origin (sometimes sent by file:// or opaque origins)
        "null",
    ]
